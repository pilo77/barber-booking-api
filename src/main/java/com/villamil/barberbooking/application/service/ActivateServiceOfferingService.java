...
@Service
class ActivateServiceOfferingService implements ActivateServiceOfferingUseCase {

	private final ServiceOfferingRepositoryPort serviceOfferingRepositoryPort;

	ActivateServiceOfferingService(ServiceOfferingRepositoryPort serviceOfferingRepositoryPort) {
	...
	public ServiceOfferingResponse activate(Long id) {
		...
		return ServiceOfferingResponse.from(serviceOfferingRepositoryPort.save(serviceOffering.activate()));
	}
}
